...
const InfoPage = () => {
    ...
    return (
        <>
        {user.authorized && <div className=" bg-blue-950 mt-4 mx-auto p-10 rounded-2xl w-[30rem] text-white flex flex-col gap-4">
            ...
            {data?.url?.userId === user.userId  && <button className=" bg-red-600 rounded-xl h-10" onClick={() => onDelete()}>Delete</button>}
        </div>}
        </>
    )
}
